...
if($_FILES[send_accessories][size]==0){	//判断是否有附件上传
	if(mysql_query("insert into tb_forum_send(tb_send_subject,tb_send_content,tb_send_user,tb_send_date,tb_send_picture,tb_send_type,tb_send_types,tb_send_small_type) values ('".$tb_send_subject."','".$tb_send_content."','".$tb_send_user."','".$tb_send_date."','".$tb_send_picture."','".$tb_send_type."','".$tb_send_types."','".$tb_send_small_type."')",$conn)){
...
if (move_uploaded_file($_FILES['send_accessories']['tmp_name'],$path)) { //将附件存储到服务器的指定位置
	if(mysql_query("insert into tb_forum_send(tb_send_subject,tb_send_content,tb_send_user,tb_send_date,tb_send_picture,tb_send_type,tb_send_types,tb_send_small_type,tb_send_accessories) values ('".$tb_send_subject."','".$tb_send_content."','".$tb_send_user."','".$tb_send_date."','".$tb_send_picture."','".$tb_send_type."','".$tb_send_types."','".$tb_send_small_type."','".$path."')",$conn)){
 		mysql_query("update tb_forum_user set tb_forum_grade=tb_forum_grade+5",$conn);
 		echo "<script>alert('新帖发表成功!');history.back();</script>";
 		mysql_close($conn);
 	}else{
