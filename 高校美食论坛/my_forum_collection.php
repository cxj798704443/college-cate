  ...
  <tr> 
   ...
   <td width="55%" height="22" align="center" bgcolor="#F7F7FF"><span class="STYLE1"> 分页： 
      <?php
				  if($page!=1)
				   {   
				     echo  "<a href=my_forum_collection.php?collection_user=ll&&page=1>首页</a>&nbsp;";
					 echo "<a href=my_forum_collection.php?collection_user=ll&&page=".($page-1).">上一页</a>&nbsp;";
				   }
				  if($page<$page_count)
				   {
				        echo "<a href=my_forum_collection.php?collection_user=ll&&page=".($page+1).">下一页</a>&nbsp;";
				        echo  "<a href=my_forum_collection.php?collection_user=ll&&page=".$page_count.">尾页</a>";
				   }
