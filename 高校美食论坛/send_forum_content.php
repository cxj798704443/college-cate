...
?>    </td>
<?php if($_SESSION[tb_forum_user]==true){	?>
...
<table width="950" height="180" border="4" align="center" cellpadding="4" cellspacing="4" bordercolor="#C8C8C8" bgcolor="#FFFFFF">
  <tr>
    <td width="200" rowspan="3" align="center" bgcolor="#FDF8CE"><span class="STYLE11">
<!--从数据库中读取出指定帖子的发布人的信息-->
<?php 
...
?></span></td>
    <td width="780" height="20%" bgcolor="#FFFFFF"><?php echo $myrow_3[tb_send_date]; ?>   楼主  
<?php 
...
?></td>
  ...
  <tr>
    <td height="20%" align="right" bgcolor="#FFFFFF"><?php if($myrow_3[tb_send_accessories]==true){echo "<a href='download.php?accessories=$myrow_3[tb_send_accessories]'>附件</a>";}?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="permute_send.php?permute_id=<?php echo $myrow_3[tb_send_id];?>">置顶</a>、<a href="recompose_send.php?recompose_id=<?php echo $myrow_3[tb_send_id];?>&&recompose_user=<?php echo $myrow_3[tb_send_user];?>">修改</a>、<a href="delete_send.php?delete_id=<?php echo $myrow_3[tb_send_id];?>&&delete_send_forum=<?php echo $myrow_3[tb_send_user];?>">删除</a>、<a href="send_forum_content.php?send_big_type=<?php echo $_GET[send_big_type];?>&&send_small_type=<?php echo $_GET[send_small_type];?>&&send_id=<?php echo $_GET[send_id];?>#bottom">回复</a></td>
  </tr>
</table>
...
?></span></td>
    <td width="780" height="20%" bgcolor="#FFFFFF"><?php echo $myrow_4[tb_restore_subject];?> &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $myrow_4[tb_restore_date]?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $i;?>楼</td>
  </tr>
 <tr>
    <td height="60%">
<?php 
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F7F7FF">
  <tr>
    <td width="643" height="10" align="right">&nbsp;</td>
    <td width="307">&nbsp;</td>
  </tr>
</table>
</body>
