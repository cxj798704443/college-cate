...
<table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#8394BF">
 <tr>
    ...
    <td width="187" align="center">创建人</td>
    <td width="249" align="center">回复次数</td>
  </tr>
<?php 
   if($page){
    $page_size=10;		//定义每页输出10条数据
	//按照指定的类别从数据库中读取帖子的数据
	...
	$query_2=mysql_query("select * from tb_forum_send where tb_send_small_type='$content_1' order by tb_send_id desc limit $offset, $page_size");
...
<td width="10%" align="center" bgcolor="#FFFFFF">
    <?php  $query_s=mysql_query("select * from tb_forum_send where tb_send_id='$myrow_2[tb_send_id]'");
