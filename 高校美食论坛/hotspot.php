    ...
    <td width="573"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                $prev_page=$page-10;						
					...
					{
                     echo "<a href='content.php?vv=0&link_type=0&page=1&content=$_GET[content]&&content_1=$_GET[content_1]&&tb_send_type_hotspot=1&&class=热点区'><img src=\"images/02.jpg\" width=\"8\" border=\"0\" height=\"9\" border=\"0\" title=\"首页\"></a>&nbsp;";
					 $ccc=$vv-10;
                     echo "<a href='content.php?vv=$ccc&link_type=$n&page=$prev_page&content=$_GET[content]&&content_1=$_GET[content_1]&&tb_send_type_hotspot=1&&class=热点区'><img src=\"images/01.jpg\" width=\"8\" height=\"9\" border=\"0\" title=\"上十页\"></a>";
					}?>
                <?php	
 		        for ($j=1;$j<=$page_count;$j++) {
				       ...
				       if ($mm==10){
						...
						?>
                <?php
                        echo "<a href='content.php?vv=$vv&link_type=$link_type&page=$pnext&content=$_GET[content]&&content_1=$_GET[content_1]&&tb_send_type_hotspot=1&&class=热点区'> $pnext </a>";											
              	        $mm=$mm+1;						
	     	     }
				 ?>			    
                </span></td>
				...
				$vv=$vv+$mm;
				       if ($page_count-$vv<=0){
	                       ...
	                       echo "<a href='content.php?vv=$vv&link_type=$m&page=$pnext&content=$_GET[content]&&content_1=$_GET[content_1]&&tb_send_type_hotspot=1&&class=热点区'><img src=\"images/03.jpg\" width=\"8\" height=\"9\" border=\"0\" title=\"下十页\"></a>";														
					   }
                if ($message_count==0){
					     echo "没有记录!";
