...
if($page==""){ $page=1; }						//判断变量的值是否为空，用于分页显示
if($pages==""){ $pages=1; } 			//判断变量的值是否为空，用于分页显示
if($link_type==""){ $link_type=0; }
if($link_types==""){ $link_types=0; }
...
<table width="100%" height="110" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="30"><a href="send_forum_content.php?send_big_type=<?php echo $_GET[content];?>&&send_id=<?php echo $myrow_8[tb_send_id];?>" target="_blank"><?php echo $myrow_8[tb_restore_subject];?></a> </td>
